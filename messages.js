...
export const FAQS = [
  {
    ...
    answer: "We will be launching on Sol blockchain, you'll need a solana wallet like phantom or sollet.",
    height: ['56px', '40px'],
  },
  {
  ...
  },
  {
    ...
    answer: 'CCs will be listed on 6th December on MagicEden, DigitalEyes & Alpha.Art',
    height: ['56px', '40px'],
  }
];
